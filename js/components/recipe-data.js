/**
 * recipe-data.js
 * Built-in seafood recipe catalogue. Loaded as a plain deferred script
 * so it works with and without a local server.
 */
...
var recipes = [
  {
    ...
    steps: [
      "Preheat the oven to 220 °C (425 °F). Split the lobster in half lengthwise with a sharp knife; season the flesh with fleur de sel.",
  ...
  },
  {
    ...
    title: "Wild Turbot",
    subtitle: "Champagne Beurre Blanc & Caviar",
    description:
    ...
    steps: [
      ...
      "Heat clarified butter in a large non-stick pan over medium-high heat until shimmering. Lay turbot skin-side down; press each fillet gently with a spatula for 10 seconds to ensure full contact. Cook without touching for 4–5 minutes.",
